...
func RemoveCSSVariables(css string) string {
...
func RemoveNestedCalc(css string) string {
...
func Minimize(css string) string {
	// Remove Comments
...
func compressRules(css string) string {
...
func FormatCSS(css string) string {
	...
	// Group selector
	css = breakSelectors(css) // Break after selectors' ,
...
func expandRules(css string) string {
...
func breakSelectors(css string) string {
